...
public interface JavaParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#statementDecision}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStatementDecision(JavaParser.StatementDecisionContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaParser#statementTry}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStatementTry(JavaParser.StatementTryContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaParser#statementLoop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStatementLoop(JavaParser.StatementLoopContext ctx);
	/**
